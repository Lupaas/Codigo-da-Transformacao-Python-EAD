...
# "nome_arquivo" cria o arquivo que ira salvar as informações 
nome_arquivo = "notas_alunos.csv"

# "campos" é uma lista que irá pegar o nome, a matéria e a nota do aluno
campos = ["Aluno", "Materia", "Nota"]

# "notas" lista com o nome + materia +  nota
notas = [
