...
# Abre o caminho para as pastas "meus_arquivos" e "backup_arquivos" do módulo 06
def obter_caminhos():
...
# Abre, exibe e direciona os arquivos que estão na pasta
...
# Possibilita voc~e selecionar e alterar o arquivo salvo em "backup_arquivos"
def editar_arquivo_backup():
    ...
    # Opções que você pode modificar do arquivo
...
# Faz uma cópia da pasta "meus_arquivos" para "backup_arquivos"
def executar_backup():
...
# Gerencia o menu principal no terminal
def menu_principal():
